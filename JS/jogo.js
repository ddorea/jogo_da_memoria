...
function timer() {
    if (!vitoria) { // Verifica se o jogo não foi vencido.
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function verifica() {
        ...
        if (cartas_iguais.length === array_cartas.length) { // Verifica o vencedor quando o jogo termina.
            alert(`Parabéns, ${nomeJogador1}! Você venceu o jogo! Clique em "Ok" para reiniciar.`);
        } else {
    ...
    function verificarVencedor() {
        ...
        if (pontosJogador1 > pontosJogador2) {
            ...
            alert(`Jogo empatado! Clique em "Ok" para reiniciar.`);
        }

        // Exibe um alerta com o vencedor e aguarda o clique no botão "Ok".
        alert(`Parabéns, ${vencedor}! Você venceu o jogo! Clique em "Ok" para reiniciar.`);

        // Após o clique em "Ok", chama a função de reinício.
        restart();
    }
